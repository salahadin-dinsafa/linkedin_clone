...
export class CreateFriendRequest1672059285052 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "friend_request" ADD CONSTRAINT "FK_9509b72f50f495668bae3c0171c" FOREIGN KEY ("senderId") REFERENCES "linkedin_users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "friend_request" ADD CONSTRAINT "FK_bd1911c687cee9137d1a00f8326" FOREIGN KEY ("reciverId") REFERENCES "linkedin_users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
