...
export class RelationOfUserToFeed1671966001956 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "feeds" ADD CONSTRAINT "FK_a1a01eb30c28276a21b04b59552" FOREIGN KEY ("authorId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
